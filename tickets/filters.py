...
class TicketFilter(django_filters.FilterSet):
    ...
    flight_date = django_filters.CharFilter(field_name='ticket__flight_date',lookup_expr='lt')
    ...
    class Meta:
        model = Ticket
        fields = ['bag','plane','aeroport','price','reassingment','flight_date','city_flight','city_arrived']
